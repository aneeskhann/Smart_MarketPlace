...
const Header = () => {
  ...
  return (
    <header className="text-black-600 body-font shadow-xl bg-white p-3">
      ...
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <Link
          to="./signin"
          className="inline-flex items-center text-white bg-red-500 border-0 py-2 px-4 focus:outline-none hover:bg-red-600 rounded-full text-base mt-4 md:mt-0   transition duration-300"
        >
          Sign in
        </Link>
        <Badge badgeContent={carts.length} color="secondary" overlap="rectangular" >
          <Link to={"/cart"}>
            <svg
              className="ml-5"
